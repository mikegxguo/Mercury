...
static GUI_CONST_STORAGE GUI_COLOR Colorsico_C[] = {
     0x000000,0xFFFFFF
};

static GUI_CONST_STORAGE GUI_LOGPALETTE Palico_C = {
  2,        /* number of entries */
  0,         /* No transparency */
  &Colorsico_C[0]
};

static GUI_CONST_STORAGE unsigned char acico_C[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmico_C = {
  64, /* XSize */
  64, /* YSize */
  8, /* BytesPerLine */
  1, /* BitsPerPixel */
  acico_C,  /* Pointer to picture data (indices) */
  &Palico_C  /* Pointer to palette */
};
