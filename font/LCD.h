...
#define LCD_DEVFUNC_FILLRECT      0x17 /* ...filling a rectangular area */
#define LCD_DEVFUNC_DRAWBMP_1BPP  0x18 /* ...drawing a 1bpp bitmap */
#define LCD_DEVFUNC_COPYBUFFER    0x19 /* ...copying complete frame buffers */
#define LCD_DEVFUNC_SHOWBUFFER    0x20 /* ...shows the given buffer */
